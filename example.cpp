...
void Example::Init()
{
    ...
    barb = mgdl_LoadTexture("assets/Ufo.png", TextureFilterModes::Linear);
    ...
    // Wii model scene
    wiiScene = mgdl_LoadFBX("assets/Ufo.fbx");
    wiiTexture = mgdl_LoadTexture("assets/Ufo.png", TextureFilterModes::Nearest);
    Scene_SetMaterialTexture(wiiScene, "Material", wiiTexture);
...
void Example::Update()
{
    ...
    static const char* babyName = "Ufo";
...
void Example::DrawIcosa()
{
    ...
    cameraDistance = 2.0f;
    DrawScene(wiiScene, V3f_Create(1.0f, 1.0f, 1.0f));
}
